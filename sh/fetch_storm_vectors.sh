#!/bin/bash
# fetch_storm_vectors.sh — pobiera środowisko konwekcyjne GFS:
#   USTM/VSTM (wektory ruchu burz), CAPE, Shear 0-6 km, WmaxShear.
# Zapisuje data/storm_vectors/storm_env_<YYYYMMDDHHZ>.npz.
#
# Uruchamiany co 6 godzin, np.:
